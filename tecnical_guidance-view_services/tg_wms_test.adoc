...
image:./media/image1.jpeg[image,width=108,height=108]
**INSPIRE**
...
Acknowledgements link:#acknowledgements[5]

Foreword link:#foreword[6]

Revision History link:#revision-history[8]

1 Introduction link:#introduction[10]

2 Normative references link:#normative-references[11]

3 Terms and abbreviations link:#terms-and-abbreviations[12]

3.1 Terms link:#terms[12]

3.2 Abbreviations link:#abbreviations[12]

3.3 Verbal forms for the expression of provisions link:#verbal-forms-for-the-expression-of-provisions[13]

3.4 References link:#references[13]

4 INSPIRE Profile of ISO 19128 link:#inspire-profile-of-iso-19128[14]

4.1 General background link:#general-background[14]

4.2 View service operations link:#view-service-operations[16]

4.2.1 Common requests parameters for the View Service operations link:#common-requests-parameters-for-the-view-service-operations[16]

4.2.2 View service exceptions link:#view-service-exceptions[16]

4.2.3 Get View Service Metadata operation link:#get-view-service-metadata-operation[17]

4.2.3.1 General link:#general[17]

4.2.3.2 GetCapabilities operation link:#getcapabilities-operation[17]

4.2.3.3 GetCapabilities response link:#getcapabilities-response[19]

4.2.4 Get Map Operation link:#get-map-operation[46]

4.2.4.1 GetMap operation link:#getmap-operation[46]

4.2.5 Link View Service operation link:#link-view-service-operation[50]

4.2.5.1 Centralised scenario link:#centralised-scenario[51]

4.2.5.2 View client scenario link:#view-client-scenario[51]

4.2.5.3 View Service scenario link:#view-service-scenario[52]

4.2.5.4 General requirement when collating maps link:#general-requirement-when-collating-maps[53]

4.3 Language Requirements link:#language-requirements[54]

4.3.1 GetCapabilities-Operation link:#getcapabilities-operation-1[54]

4.3.1.1 GetMap-Operation link:#getmap-operation-1[57]

4.3.2 Common concept for other operations (optional) link:#common-concept-for-other-operations-optional[57]

4.3.3 Further Perspectives link:#further-perspectives[59]

5 INSPIRE Profile of WMTS 1.0.0 link:#inspire-profile-of-wmts-1.0.0[60]

5.1 General background link:#general-background-1[60]

5.2 View service operations link:#view-service-operations-1[60]

5.2.1 Common requests parameters for the View Service operations link:#common-requests-parameters-for-the-view-service-operations-1[61]

5.2.2 View service exceptions link:#view-service-exceptions-1[61]

5.2.3 Get View Service Metadata operation link:#get-view-service-metadata-operation-1[61]

5.2.3.1 General link:#general-1[61]

5.2.3.2 GetCapabilities operation link:#getcapabilities-operation-2[62]

5.2.3.3 GetCapabilities response link:#getcapabilities-response-1[62]

5.2.4 Get Map Operation link:#get-map-operation-1[76]

5.2.4.1 GetTile operation link:#gettile-operation[76]

5.2.5 Link View Service operation link:#link-view-service-operation-1[77]

5.2.6 Language Requirements link:#language-requirements-1[77]

5.2.6.1 GetCapabilities link:#getcapabilities[77]

5.2.6.2 Exceptions link:#exceptions-1[78]

5.2.7 Interoperability: TileMatrixSet link:#interoperability-tilematrixset[78]

5.2.7.1 InspireCRS84Quad link:#inspirecrs84quad[78]

5.2.7.2 Schema definition for extended capabilities for OWS 1.1 (inspire_vs_ows_11.xsd) link:#schema-definition-for-extended-capabilities-for-ows-1.1-inspire_vs_ows_11.xsd[80]

6 Quality of Services link:#quality-of-services[81]

6.1 General requirements link:#general-requirements[81]

6.2 Performance link:#performance[81]

6.2.1 Implementation requirements mandated by the Implementing Rule link:#implementation-requirements-mandated-by-the-implementing-rule[81]

6.2.2 Normalized testing procedure link:#normalized-testing-procedure[81]

6.3 Capacity link:#capacity[82]

6.3.1 Implementation requirements mandated by the Implementing Rule link:#implementation-requirements-mandated-by-the-implementing-rule-1[82]

6.3.2 Normalized testing procedure link:#normalized-testing-procedure-1[82]

6.4 Availability link:#availability[83]

6.4.1 Implementation requirements mandated by the Implementing Rule link:#implementation-requirements-mandated-by-the-implementing-rule-2[83]

6.4.2 Normalized testing procedure link:#normalized-testing-procedure-2[83]

Annex A INSPIRE Profile of Tiling WMS link:#_toc1913[84]

Annex B Capabilities extension for other profiles link:#_toc2038[95]

Annex C Example of Extended Capabilities Response Scenario 1 link:#Ref_1[105]

Annex D Example of Extended Capabilities Response Scenario 2 link:#_Ref161992236[108]

Annex E Examples of SLD usage link:#_Toc227149341[112]

Annex F INSPIRE Network Services Regulation Compliance link:#_toc2165[114]

*Figures*

Figure 1: Relationship between INSPIRE Implementing Rules and Technical Guidance link:#_Ref137635453[7]

Figure 2: Extending ISO and OGC Standards for INSPIRE Requirements link:#_Toc159065326[10]

Figure 3: INSPIRE Generic Use Case link:#_Ref162312273[14]

Figure 4: Get View Service Metadata Use Case (UC1) link:#_Ref161740370[18]

Figure 5: Illustration of the Extended Capabilities for Scenario 1 and 2 for INSPIRE View Services link:#_Ref162313236[20]

Figure 6: Get Map Activity (Use case 4) link:#_Toc159065330[47]

Figure 7: Client approach link:#_Toc227149271[52]

Figure 8: Service approach link:#_Toc227149272[53]

Figure 9: TILEMATRIXSET concept link:#_Toc227149273[72]

Figure 10: TILEMATRIXSET concept link:#_Toc227149274[72]

Figure 11: Level 1 GoogleCRS84Quad, Four 256x256 pixels tiles link:#_Ref224365615[79]

Figure 12: Level 0 InspireCRS84Quad. Two 256x256 pixels tiles. link:#_Toc227149276[79]

*Tables*

Table 1: View Service Operations link:#_Ref161913256[16]

Table 2: GetCapabilities core parameters link:#_Toc227149248[17]

Table 3: Mapping between INSPIRE metadata elements and [ISO 19128] WMS elements link:#_Ref157229052[21]

Table 4: Mapping between INSPIRE layer metadata elements and ISO 19128 WMS elements link:#_Ref161804377[32]

Table 5: Annexes I harmonised name examples link:#_Toc159065335[38]

Table 6: CRS recommended codes link:#_Toc159065336[39]

Table 7 INSPIRE and ISO 19128 parameters mapping link:#_Ref161914628[46]

Table 8: GetMap core parameters link:#_Toc159065338[48]

Table 9: Language parameter link:#_Toc159065339[54]

Table 10: Mapping between ISO 639/B alpha 3 and the two forms of IETF RFC 4646 supported by OWS 1.1.0 link:#_Toc227149256[59]

Table 11: View Service Operations link:#_Toc159065340[60]

Table 12: GetCapabilities core parameters link:#_Toc159065341[62]

Table 13: Mapping between INSPIRE layer metadata elements and OGC WMTS elements link:#_Toc227149259[66]

Table 14: INSPIRE and WMS parameters mapping link:#_Toc159065342[76]

Table 15: GetTile core parameters link:#_Ref162320990[77]

Table 16: InspireCRS84Quad – Pixel size for each level link:#_Toc227149262[78]

Table 17: Downtime per week, month, year link:#_Toc227149263[83]

Table 18: INSPIRE Network Services Regulation Compliance link:#_Toc227149264[114]
...
Example 1: Resource title link:#_Toc156382979[22]

Example 2: Resource abstract link:#_Toc159065345[22]

Example 3: Coupled resource (MetadataURL) link:#_Toc227149059[23]

Example 4: Keyword link:#_Toc227149060[25]

Example 5: Geographic bounding box link:#_Toc227149061[25]

Example 6: Conditions for access and use link:#_Toc159065347[27]

Example 7: Limitations on public access link:#_Toc159065348[28]

Example 8: Responsible organisation link:#_Toc159065349[28]

Example 9: Operations metadata link:#_Toc159065350[30]

Example 10: GetMap operation metadata link:#_Toc159065351[31]

Example 11: Layers Metadata link:#_Toc159065352[32]

Example 12: Resource title link:#_Toc159065353[33]

Example 13: Resource abstract link:#_Toc159065354[33]

Example 14: Keyword link:#_Toc227149070[34]

Example 15: Geographic bounding box link:#_Toc159065356[34]

Example 16: Sample from Metadata Technical Guidance [INS MDTG] demonstrating this concept link:#_Toc227149072[35]

Example 17: Authority URL link:#_Toc227149073[36]

Example 18: Name link:#_Toc159065358[38]

Example 19: Coordinate reference systems link:#_Toc159065359[39]

Example 20: Styles link:#_Toc159065360[41]

Example 21: Legend URL link:#_Toc159065361[41]

Example 22: Dimension Pairs link:#_Toc159065362[43]

Example 23: Category layer link:#_Toc159065363[44]

Example 24: Link View Service – View Service search (CSW.GetRecords request) link:#_Toc159914812[50]

Example 25: Response to [OGC-GetCapabilities-Request]&LANGUAGE=eng link:#_Toc159065367[56]

Example 26: Response to [OGC-GetCapabilities-Request] or [OGC-GetCapabilities-Request]&LANGUAGE=fre link:#_Toc159065368[56]

Example 27: Response to any GetCapabilities-Request link:#_Toc159065369[56]

Example 28: Service response including supported languages link:#_Toc159065370[57]

Example 29: Response to [OCG-GetCapabilities-Request]&LANGUAGE=eng or [OCG-GetCapabilities-Request link:#_Toc159065371[58]

Example 30: Response to [OCG-GetCapabilities-Request]&LANGUAGE=ger link:#_Toc156382990[58]

Example 31: WMTS GetCapabilities structure link:#_Toc159065374[63]

Example 32: GetCapabilities Operation Metadata link:#_Toc159065375[64]

Example 33: GetMap operation metadata link:#_Toc159065376[64]

Example 34: Languages link:#_Toc227149090[65]

Example 35: Layers Metadata link:#_Toc159065377[65]

Example 36: Resource title link:#_Toc159065378[66]

Example 37: Resource abstract link:#_Toc159065379[67]

Example 38: Keywords link:#_Toc159065380[68]

Example 39: Geographic Bounding Box link:#_Toc227149095[69]

Example 40: Unique resource identifier link:#_Toc227149096[69]

Example 41: Name link:#_Toc159065383[71]

Example 42: Link to TILEMATRIXSET on the spatial dataset link:#_Toc227149098[73]

Example 43: Styles link:#_Toc159065387[74]

Example 44: Legend URL link:#_Toc159065388[75]

Example 45: INSPIRE Profile for Tiling WMS link:#_Toc159065391[84]

Example 46: WMS 1.1.1 Profile link:#_Toc159065392[95]

Example 47: Extended Capabilities Response Scenario 1 link:#_Toc227149103[105]

Example 48: Extended Capabilities Response Scenario 2 link:#_Toc227149104[108]

Example 49: Examples of SLD usage link:#_Toc227149105[112]
...
[#_Ref137635453 .anchor]####Figure : Relationship between INSPIRE Implementing Rules and Technical Guidance
...
[width="100%",cols="16%,10%,20%,54%",options="header",]
|===
...
[#_Toc159065326 .anchor]####Figure : Extending ISO and OGC Standards for INSPIRE Requirements
...
[#_Ref162312273 .anchor]####Figure : INSPIRE Generic Use Case
...
[#_Ref161913256 .anchor]####Table : View Service Operations
...
[#_Toc227149248 .anchor]####Table : GetCapabilities core parameters
...
[#_Toc156382979 .anchor]####Example : Resource title
...
[#_Toc159065345 .anchor]####Example : Resource abstract
...
[#_Toc227149059 .anchor]####Example : Coupled resource (MetadataURL)
...
##    <onlineresource <="" evid="" xmlns:xlink="http://www.w3.org/1999/xlink">
##        xlink:type="simple"##
...
[#_Toc227149060 .anchor]####Example : Keyword
...
[#_Toc227149061 .anchor]####Example : Geographic bounding box
...
[#_Toc159065347 .anchor]####Example : Conditions for access and use
...
[#_Toc159065350 .anchor]####Example : Operations metadata

[source,xml,subs="+quotes"]
----
<wms:wms_capabilities 1999="" <evid="" http:="" version="1.3.0" www.w3.org="" xlink"="" xmlns:wms="http://www.opengis.net/wms>
...
<evid><wms:GetCapabilities></evid>


<evid><wms:Format>text/xml</wms:Format></evid>


...


<evid><wms:DCPType></evid>
...
[#_Toc159065352 .anchor]####Example : Layers Metadata
...
[#_Toc159065354 .anchor]####Example : Resource abstract
...
[#_Toc227149070 .anchor]####Example : Keyword
...
[#_Toc159065356 .anchor]####Example : Geographic bounding box
...
[#_Toc227149072 .anchor]####Example 16: Sample from Metadata Technical Guidance [INS MDTG] demonstrating this concept
...
[#_Toc227149073 .anchor]####Example 17: Authority URL
...
[#_Toc159065335 .anchor]####Table : Annexes I harmonised name examples
...
[#_Toc159065358 .anchor]####Example : Name
...
<evid><wms:Name>TN.RoadTransportNetwork.RoadArea</wms:Name></evid>
...
[#_Toc159065336 .anchor]####Table : CRS recommended codes
...
[#_Toc159065359 .anchor]####Example : Coordinate reference systems
...
[#_Toc159065361 .anchor]####Example : Legend URL
...
##      <wms:format>
    ...
    <wms:onlineresource <evid="" xmlns:xlink="http://www.w3.org/1999/xlink">
      xlink:type="simple"
##        xlink:href="URL"##
##        />##
##        <wms:legendurl>
...
[#_Toc159065363 .anchor]####Example : Category layer
...
<evid><evid><evid><wms:Name></evid></evid>HY.PHYSICALWATERS.WATERBODIES<evid><evid></wms:Name></evid></evid></evid>


<evid><evid><evid><wms:Title></evid></evid>Hydrography Physical Waters : Waterbodies<evid><evid></wms:Title></evid></evid></evid>


<evid><MetadataURL type=">
##    <format>
      text/xml
    </format>##
##    <onlineresource <="" evid="" xmlns:xlink="http://www.w3.org/1999/xlink">
...
[#_Toc159065330 .anchor]####Figure : Get Map Activity (Use case 4)

====== GetMap request parameters

[#_Toc159065338 .anchor]####Table : GetMap core parameters
...
[#_Toc159914812 .anchor]####Example 24: Link View Service – View Service search (CSW.GetRecords request)
...
[#_Toc227149271 .anchor]####Figure : Client approach
...
[#_Toc227149272 .anchor]####Figure : Service approach
...
[#_Toc159065339 .anchor]####Table : Language parameter

[width="100%",cols="17%,43%,17%,23%",options="header",]
|===
...
[#_Toc159065368 .anchor]####Example : Response to [OGC-GetCapabilities-Request] or +
...
[#_Toc159065369 .anchor]####Example : Response to any GetCapabilities-Request
...
[#_Toc159065370 .anchor]####Example : Service response including supported languages
...
[#_Toc156382990 .anchor]####Example : Response to [OCG-GetCapabilities-Request]&LANGUAGE=ger
...
[#_Toc227149256 .anchor]####Table 10: Mapping between ISO 639/B alpha 3 and the two forms of IETF RFC 4646 supported by OWS 1.1.0

[width="100%",cols="28%,33%,39%",]
|===
...
[#_Toc159065340 .anchor]####Table : View Service Operations
...
[#_Toc159065341 .anchor]####Table : GetCapabilities core parameters
...
[#_Toc159065374 .anchor]####Example 31: WMTS GetCapabilities structure
...
Operations metadata are mapped to the
<ows:operationsmetadata>
  element. There are two mandatory operations in the Operations Metadata: "Get View Service Metadata" implemented with the GetCapabilities WMTS operation and "Get Map" implemented with the GetTile WMTS operation.
...
[IMPORTANT]
====
Implementation Requirement 81 The GetCapabilities operation metadata shall be mapped to the
...
[#_Toc159065375 .anchor]####Example : GetCapabilities Operation Metadata
    <ows:operationsmetadata>
      <ows:operation name="GetCapabilities">
        <ows:dcp>
          <ows:http>
...
[#_Toc227149090 .anchor]####Example : Languages
...
[#_Toc159065377 .anchor]####Example : Layers Metadata
...
[#_Toc227149259 .anchor]####Table : Mapping between INSPIRE layer metadata elements and OGC WMTS elements
...
[#_Toc159065379 .anchor]####Example : Resource abstract
...
[#_Toc227149095 .anchor]####Example : Geographic Bounding Box
...
[#_Toc227149096 .anchor]####Example 40: Unique resource identifier
...
<evid><ows:Identifier></evid>inspire_common:DEFAULT<evid></ows:Identifier></evid>
...
[#_Toc159065383 .anchor]####Example : Name
...
[#_Toc227149273 .anchor]####Figure : TILEMATRIXSET concept

image:./media/image11.png[image,width=482,height=298]

[#_Toc227149274 .anchor]####Figure : TILEMATRIXSET concept

As a result, the unique link between a layer and a _TileMatrixSet_ implicitly defines the CRS for this layer.

[#_Toc227149098 .anchor]####Example : Link to TILEMATRIXSET on the spatial dataset
...
[#_Toc159065387 .anchor]####Example : Styles
...
<evid><ows:Title>Style for roads</ows:Title></evid>


<evid><ows:Identifier>inspire_common:DEFAULT</ows:Identifier></evid>
...
[#_Toc159065388 .anchor]####Example : Legend URL
...
<evid><LegendURL format="image/png"</evid>


<evid>xlink:href="http://www.maps.bob/etopo2/legend.png" /></evid>
...
[#_Toc159065342 .anchor]####Table : INSPIRE and WMS parameters mapping
...
[#_Toc227149262 .anchor]####Table 16: InspireCRS84Quad – Pixel size for each level
...
[#_Toc227149276 .anchor]####Figure : Level 0 InspireCRS84Quad. Two 256x256 pixels tiles.
...
[#_Toc227149263 .anchor]####Table : Downtime per week, month, year

[width="100%",cols="27%,24%,24%,25%",]
|===
...
[upperalpha]
. [#_toc1913 .anchor]####INSPIRE Profile of Tiling WMS
...
[#_Toc159065391 .anchor]####Example : INSPIRE Profile for Tiling WMS
...
[upperalpha]
. [#_toc2038 .anchor]####Capabilities extension for other profiles

*WMS 1.1.1 Profile*

[#_Toc159065392 .anchor]####Example : WMS 1.1.1 Profile
...
[upperalpha, start=2]
. [#Ref_1 .anchor]####Example of Extended Capabilities Response Scenario 1

[#_Toc227149103 .anchor]####Example 47: Extended Capabilities Response Scenario 1
...
[upperalpha, start=3]
. [#_Ref161992236 .anchor]####Example of Extended Capabilities Response Scenario 2

[#_Toc227149104 .anchor]####Example 48: Extended Capabilities Response Scenario 2
...
[upperalpha, start=4]
. [#_Toc227149341 .anchor]####Examples of SLD usage
...
[#_Toc227149105 .anchor]####Example 49: Examples of SLD usage
...
[upperalpha, start=5]
. [#_toc2165 .anchor]####INSPIRE Network Services Regulation Compliance
...
[#_Toc227149264 .anchor]####Table : INSPIRE Network Services Regulation Compliance

[width="100%",cols="12%,54%,12%,12%,10%",]
|===
