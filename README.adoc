...
//ifdef::env-github[]
//:imagesdir: https://github.com/fabiovinci/TG_conversion/blob/main/media
//:toc: left
//endif::[]
...
image::./media/image2.png[TGvsIR,width=600,height=450,align="center"]
...
image::./media/image3.png[image,width=563,height=424,align="center"]
//image::./media/image2.png[TGvsIR,width=600,height=450,align="center"]
